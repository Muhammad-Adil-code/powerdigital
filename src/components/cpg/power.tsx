        ...
        <div className="paragraph">
          <p>
            <span style={{ fontWeight: 400 }}>
              This isn’t just about running campaigns. It’s about building an integrated marketing ecosystem that supports every part of your business, from digital growth to retail partnerships.
            </span>
          </p>
          <p>
            <span style={{ fontWeight: 400 }}>
        ...
        <div className="multi-text-section__row">
          <div className="item">
            <div className="text">
              ...
              <p>
                <span style={{ fontWeight: 400 }}>
We turn raw insights into actionable, retail-ready plays.                </span>
              </p>
            </div>
          </div>
          <div className="item">
            <div className="text">
              ...
              <p>
                <span style={{ fontWeight: 400 }}>
Your ads can be beautiful and efficient, driving measurable results.                </span>
              </p>
            </div>
          </div>
          <div className="item">
            <div className="text">
              ...
              <p>
                <span style={{ fontWeight: 400 }}>
Launch fast. Scale smart. Retain customers.                </span>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="multi-text-section__row">
          <div className="item">
            <div className="text">
              ...
              <p>
                <span style={{ fontWeight: 400 }}>
We build synergy across retail, DTC, Amazon, and more.                </span>
              </p>
            </div>
          </div>
          <div className="item">
            <div className="text">
              ...
              <p>
                <span style={{ fontWeight: 400 }}>
Every tactic. Every campaign. Every channel — proven.                </span>
              </p>
            </div>
          </div>
        </div>
