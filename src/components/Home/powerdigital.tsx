      ...
      <section className="data-driven-insight bg-dark">
        <div className="separator">
          <div className="separator__title">
            <h2>Get insights that defeat doubts.</h2>
        ...
        /> */}
          ...
          <div className="data-driven-insight__text">
            ...
            <div className="paragraph">
              <p>
                At Burac.ai, we invest in breakthrough technology and exceptional developers to achieve outcomes that beat expectations. Partner with us for a comprehensive, AI-powered approach designed to drive growth, boost profitability, and future-proof your firm.
              </p>
            </div>
            <a
