    ...
    <section className="full-image-testimonial bg-dark  section-inner">
      ...
      <article className="2 note fade-up is-article-inner ">
        <div className="note__text">
          <p>
            <em>
              “Since partnering with Burac.ai, our pipeline performance has skyrocketed.  Their comprehensive awareness of our procedures and customer journey elevated leads, conversion, and operational efficiency to new heights.  Burac.ai truly invests in our success.”
            </em>
          </p>
        </div>
