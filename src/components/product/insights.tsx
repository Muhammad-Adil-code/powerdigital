          ...
          <div className="multi-text-section__row">
              ...
              <div className="text">
                ...
                <p>
                  <span style={{ fontWeight: 400 }}>
                    We find possibilities, analyze performance, and execute with agility — keeping your brand ahead in a fast-moving consumer landscape.
                  </span>
                </p>
              </div>
            </div>
            <div className="item">
              <div className="text">
                ...
                <p>
                  <span style={{ fontWeight: 400 }}>
                    Our team includes some of the finest minds in consumer tech and AI-driven solutions, with a 96%+ client retention record.  Expect nothing less than best-in-class.
                  </span>
                </p>
              </div>
            </div>
            <div className="item">
              <div className="text">
                ...
                <p>
                  <span style={{ fontWeight: 400 }}>
                    Our strategies produce measurable impact:  2.6x quicker growth than industry averages and 27+% YoY revenue gains – every effort focused for optimum ROI.
                  </span>
                </p>
              </div>
            </div>
