    ...
    <section className="full-image-testimonial bg-light  section-inner">
      ...
      <article className="2 note fade-up is-article-inner ">
        <div className="note__text">
          <p>
            “With Burac.ai by our side, we’ve gained more than a technology partner — we’ve found allies who champion L’AGENCE’s mission. Their work goes beyond traditional digital solutions, ensuring every strategy is scalable, sustainable, and impactful.”
          </p>
        </div>
