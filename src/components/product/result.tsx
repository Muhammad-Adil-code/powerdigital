      ...
      <section className="section-three-data-number bg-dark">
          ...
          <div className="section-three-data-number__insight insight-section">
            ...
            <div>
              <div className="item">
                ...
                <p>
                  Data points exploited by Burac.ai applications to drive insights
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="section-three-data-number__image-text">
          ...
          <div className="text">
            ...
            <div className="description">
              <p>
                Burac.ai helped ViX Paula Hermanny scale sustainably.  By assessing main audience segments, refining acquisition and retention offers, and implementing a complex AI-driven marketing mix, we grabbed higher-value customers while cutting discounts and advertising expenses – producing dramatic top-line growth.
              </p>
            </div>
          </div>
        </div>
